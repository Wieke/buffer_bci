...
for thisTrial in trials:
    ...
    # buffer_bci Sending trailStart event
    ...
    for thisStimulus in stimuli:
        ...
        # buffer_bci sending stimulus event
...
# buffer_bci Add a counter for the feedback phase
...
for thisTrial_2 in trials_2:
    ...
    # buffer_bci Send feedbackStimulus event
    sendEvent("feedbackStimulus" + str(feedbackCounter), "")
    ...
    frameN = -1
    routineTimer.add(2.000000)
    # buffer_bci Getting feedback
    feedback = geteventvalue("feedbackStimulusResponse" + str(feedbackCounter)) 
